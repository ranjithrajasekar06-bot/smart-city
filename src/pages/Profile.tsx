  ...
  useEffect(() => {
    const fetchUserIssues = async (retryCount = 0) => {
      ...
      try {
        ...
        if (err.isStarting && retryCount < 3) {
          console.log(`Profile: Server starting, retrying in 2s (attempt ${retryCount + 1})...`);
          setTimeout(() => fetchUserIssues(retryCount + 1), 2000);
          return;
        }
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                ...
                <div className="text-[10px] text-blue-600 font-semibold uppercase tracking-wider">Reports</div>
              </motion.div>
              <motion.div 
                whileHover={{ y: -2 }}
              ...
              >
                ...
                <div className="text-[10px] text-green-600 font-semibold uppercase tracking-wider">Resolved</div>
              </motion.div>
            </div>
          </div>
        </motion.div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="p-6 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
              <div className="flex items-center">
                ...
                <h2 className="font-bold text-gray-900">Your Reported Issues</h2>
              </div>
              ...
              <AnimatePresence mode="wait">
                {loading ? (
                  ...
                  >
                    ...
                    <p className="text-gray-500 mb-6">You haven't reported any community issues yet.</p>
                    <Link
                      to="/report"
                            ...
                            <div className="flex items-center flex-1 min-w-0 mr-4">
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="flex items-center mt-1 space-x-3 text-xs text-gray-500">
                                  <span className="capitalize px-2 py-0.5 bg-gray-100 rounded-md">{issue.category}</span>
                                  <span>•</span>
